 ...
 */
std::vector<SourceLine> genTokenFile(std::ofstream& tokenFile,
...
MemLayout generateParserFile(std::ofstream& parserFile,
                             const std::vector<SourceLine>& tokenizedLines) {
    Parser parser{};
...
int main(const int argc, char* argv[]) {
    ...
    try {
        ...
        const std::vector<SourceLine> tokenizedLines = genTokenFile(tokenFile, programLines);
